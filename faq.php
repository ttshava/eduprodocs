...
$page_description = 'Answers to the questions Zimbabwean schools ask most before deploying Edupro SMS — pricing, 72-hour deployment, offline capability, data security, modules, ZIMSEC & Cambridge curriculum support, and ongoing support.';
$current_page     = 'faq';
require_once $_SERVER['DOCUMENT_ROOT'] . '/includes/site-config.php';

/**
 * FAQPage structured data. Kept as a plain-text mirror of the visible
 * .faq-item markup below (not rendered from this array — the HTML is
 * hand-authored for the accordion/search UI) so AI search engines and
 * Google's AI Overviews can lift exact Q&A pairs.
 */
$_faq_items = [
    ['q' => 'What is Edupro SMS?', 'a' => "Edupro SMS (School Management System) is a complete, modular software platform built specifically for Zimbabwean schools. It manages learner records, admissions, attendance, school fees, timetabling, academic reporting, communications, e-learning, asset management, and staff training in one integrated system. It is designed for both ZIMSEC Heritage-Based Curriculum schools and Cambridge International schools, and works fully offline on the school's own local server."],
    ['q' => 'Is Edupro SMS built specifically for Zimbabwe, or is it a generic African system?', 'a' => 'Edupro SMS was designed specifically for the Zimbabwean school environment. It supports ZIMSEC grading scales, subject codes, and Ministry attendance return formats; handles USD and ZiG (Zimbabwe Gold) as currencies; integrates with EcoCash, Innbucks, RTGS, and Steward Bank; works offline; and reflects Zimbabwean school terms and levy types. It is not a generic product adapted for Zimbabwe — it was built from the ground up for this context.'],
    ['q' => 'How many schools are currently using Edupro SMS?', 'a' => 'Edupro SMS is currently live at schools across Zimbabwe, including Avondale Primary (Harare, 1,600 students), Gresham Primary (Zvishavane, 1,700 students), and First Class High School (Mutare, 600 students, boarding). No school has left the platform since its launch. See the full client list at edupro.co.zw/clients.php.'],
    ['q' => 'Can I see examples of schools using Edupro SMS?', 'a' => 'Yes — visit the Clients page at edupro.co.zw/clients.php for the full list of schools and organisations currently using Edupro SMS, including which modules each one runs and how many students each system manages.'],
    ['q' => 'Does Edupro only work for schools?', 'a' => "No. While Edupro SMS itself is built for schools, the Moodle LMS module is also deployed for non-school clients — including the Ministry of Health (serving all registered nurses nationwide) and Health Safety Solutions — for staff training and learning management outside the classroom."],
    ['q' => 'Who owns the data stored in Edupro SMS?', 'a' => "The school owns 100% of its data — always. Edupro SMS is the custodian of the system and provides support, but the school's data belongs to the school. If a school stops using Edupro SMS, they retain full access to their data."],
    ['q' => 'Does Edupro SMS have a parent portal?', 'a' => "Yes. The parent portal allows parents to view their child's fee account balance, download receipts, check attendance records, and access academic reports from a smartphone browser. COM-400 also pushes fee receipts, absentee alerts, and school announcements directly to parents via WhatsApp and SMS."],
    ['q' => 'Is Edupro SMS endorsed or certified by the Ministry of Primary and Secondary Education (MoPSE)?', 'a' => 'Edupro SMS is independently developed and positioned; it is not currently an official MoPSE system. However, it is designed to comply fully with MoPSE reporting requirements — attendance returns, class registers for inspector visits, ZIMSEC attendance certificates, and termly statistical tables are generated in Ministry-standard formats.'],
    ['q' => 'What devices can staff use to access the system?', 'a' => "Edupro SMS is browser-based — any device with a modern web browser can access the system on the school's local network, including desktop and laptop computers, tablets, and smartphones. No software installation is required on staff devices."],
    ['q' => 'Is there a mobile app for Edupro SMS?', 'a' => 'Currently, Edupro SMS is browser-based and works on any device through a web browser, including smartphones. A dedicated mobile app is on the product roadmap; in the meantime the interface is optimised for mobile screens.'],

    ['q' => 'How much does Edupro SMS cost?', 'a' => 'There are two cost components: a once-off setup fee of $2,000 USD covering full installation, data migration, configuration of all modules, school branding, and staff training; and ZimHPC cloud hosting for online deployments at $14 USD/month. Optional Managed Services cost $250/term (Basic) or $400/term (Full). There are no per-user, per-learner, or per-module fees.'],
    ['q' => 'What is the difference between Basic and Full Managed Services?', 'a' => 'Basic Managed Services ($250/term) includes remote phone and WhatsApp support during school hours, remote desktop support sessions, system updates and patches, and a 4-hour response time. Full Managed Services ($400/term) includes everything in Basic, plus a scheduled on-site visit each term, priority 2-hour response time, proactive system health monitoring, refresher staff training, and a term-end review meeting.'],
    ['q' => 'Are there per-learner or per-user charges?', 'a' => 'No. Edupro SMS is priced per school, not per learner, teacher, or module. Whether a school has 100 learners or 2,000, the price is the same, and all 10 modules are included in the setup fee.'],
    ['q' => 'Can we start with fewer modules and pay less?', 'a' => 'The $2,000 setup fee covers the full system including all 10 modules, with no reduced price for fewer modules. Schools are not obligated to use all modules immediately; many start with 3–4 modules and adopt the rest over time.'],
    ['q' => 'What payment methods does Edupro accept from schools?', 'a' => 'USD cash, USD bank transfer (RTGS), and EcoCash. All pricing is quoted in USD. Managed service invoices are sent to the Bursar before the start of each term.'],
    ['q' => "Who pays for hardware if our school doesn't have a server?", 'a' => "Hardware is the school's responsibility. The $2,000 setup fee covers software installation and configuration only. Edupro's technical team assesses needs and recommends specifications; the school sources and purchases the hardware."],
    ['q' => 'What happens if we stop paying managed services? Does the system shut down?', 'a' => "No. The system continues to work — it runs on the school's own server and the school owns the licence. Stopping managed services moves the school to a self-managed arrangement without support, but data remains the school's at all times."],

    ['q' => 'What does "72-hour deployment" actually mean?', 'a' => 'From the moment the technical team arrives at the school with a signed agreement, the full system — installed, configured, data migrated, and staff trained — is operational within 72 working hours. This covers server setup, module configuration, import of existing student and fee data, document branding, and role-specific training.'],
    ['q' => 'What does the school need to prepare before deployment day?', 'a' => "A student register spreadsheet, fee structure details, staff list, the school's logo, a designated server or computer, and a designated IT contact person. A pre-deployment site visit assesses infrastructure and guides preparation."],
    ['q' => 'Will you come to our school if we are not in Harare?', 'a' => "Yes. Edupro SMS deploys nationally across all 10 provinces. For schools outside Harare, the team plans a multi-day visit combining deployment and training. Travel and accommodation costs are the school's responsibility and are included in the deployment proposal."],
    ['q' => 'Can you migrate data from our existing spreadsheets or system?', 'a' => 'Yes. The technical team migrates existing data from Excel and CSV files as part of setup, typically including student records, historical fee ledger balances, and staff information.'],
    ['q' => 'What training is provided for staff?', 'a' => 'Role-specific training is included in the setup fee: Bursar & Finance Staff (4 hours, FIN-500), Class Teachers (2 hours, ATT-300/Moodle basics), Heads of Department (3 hours, RPT-800/TTS-300/ATT-300), Headmaster & Management (1.5 hours, dashboards/board reports), and IT Coordinator/Admin (2 hours, server maintenance/backups/user management).'],
    ['q' => 'Our staff are not very tech-savvy. Will they manage?', 'a' => 'Edupro SMS is designed for school staff, not IT professionals. Common tasks are designed to be completable in a few clicks, and most staff are confidently handling daily tasks within one day of training.'],
    ['q' => 'Can we run Edupro SMS alongside our existing system before fully switching over?', 'a' => "Yes, and it's recommended. Schools typically run Edupro SMS in parallel with existing processes for a short period to verify data accuracy and build staff confidence before the Headmaster signs a final go-live confirmation."],

    ['q' => 'Our school has very unreliable internet. Can we still use Edupro SMS?', 'a' => "Yes — this is exactly what Edupro SMS was designed for. The system runs entirely on the school's local server; teachers, the Bursar, and management can work without any internet connection. Internet is only needed for cloud backup and parent SMS/WhatsApp notifications, which queue automatically when offline."],
    ['q' => 'Our school has no internet at all. Can we still use the system?', 'a' => 'Yes. All core functions — attendance, fee recording, report cards, timetabling, student records — work 100% offline. Only cloud backup, parent alerts, and the online parent portal require internet. Schools with no internet are set up with a local external hard drive backup schedule.'],
    ['q' => 'What happens to our data if the internet goes down mid-day?', 'a' => 'Nothing. The system keeps working normally, saving data to the local server. Pending cloud syncs happen automatically once connectivity is restored.'],
    ['q' => 'What is ZimHPC and why is it used for cloud backup?', 'a' => "ZimHPC is the Zimbabwe Higher Performance Computing Centre at the University of Zimbabwe in Harare — a secure local data centre used for cloud backup so schools' data stays in Zimbabwe rather than servers abroad."],
    ['q' => 'How much internet data does Edupro SMS use when syncing?', 'a' => 'Sync uses only incremental data — changes since the last sync — typically a few megabytes per day, sustainable even on limited LTE mobile data plans.'],
    ['q' => "What happens if the school's local server loses power mid-session?", 'a' => 'The system auto-saves every 30 seconds, so at most 30 seconds of data entry could be affected. Schools are advised to connect the server to a UPS with a minimum 2-hour runtime; the server restarts automatically when power returns.'],

    ['q' => "Where is our school's data stored?", 'a' => "Data is stored primarily on the school's own local server, on its premises. For online deployments, encrypted backup copies are stored at ZimHPC (University of Zimbabwe). Edupro SMS does not store school data on Edupro's own servers."],
    ['q' => "Can Edupro staff access our school's data?", 'a' => "Only with explicit consent — for example during a support session the school initiates. All remote access sessions are logged, and Edupro does not maintain standing access to a school's system outside support engagements."],
    ['q' => 'How is learner data protected — especially for minors?', 'a' => "Learner data is stored on the school's local server with role-based access controls; only authorised users can view student records. Cloud backup data is encrypted in transit and at rest, and the parent portal is authenticated per parent."],
    ['q' => 'What happens to our data if the server hardware fails completely?', 'a' => 'For online deployments with ZimHPC backup active, all data up to the last sync point is recoverable onto replacement hardware. Offline-only schools recover from their most recent local backup, which is part of the standard deployment checklist.'],
    ['q' => 'Are QR receipts secure? Can they be faked?', 'a' => "FIN-500's QR receipts link to a verification endpoint that confirms authenticity in real time. Fraudulent (photocopied or digitally altered) receipts will not pass verification, protecting schools from a common fee-collection fraud risk."],
    ['q' => 'What user roles and permissions are available?', 'a' => 'Standard roles include System Administrator, Headmaster, Bursar, Deputy Head, Class Teacher, Registrar, and Parent, each with role-based access to relevant modules and data. Custom roles can be configured during setup.'],

    ['q' => 'Does FIN-500 support both USD and ZiG (Zimbabwe Gold)?', 'a' => "Yes. FIN-500 supports USD and ZiG as dual currencies with a Bursar-set exchange rate per term. Mixed-currency payments are recorded accurately on the receipt, and financial reports are available in either currency."],
    ['q' => 'Does ATT-300 automatically send a message to parents when a child is absent?', 'a' => "Yes. When a student is marked absent, ATT-300 triggers COM-400 to send a WhatsApp or SMS alert to the parent's registered number automatically. Alerts queue and send once connectivity is available if the school is offline."],
    ['q' => 'What e-learning platform powers LMS-200?', 'a' => 'LMS-200 is powered by Moodle, the world\'s most widely used open-source Learning Management System, trusted by over 400 million learners globally, including the University of Zimbabwe. It runs on the school\'s local server and syncs to the cloud when internet is available.'],
    ['q' => 'Can RPT-800 generate report cards for both ZIMSEC and Cambridge students in the same school?', 'a' => "Yes. RPT-800 supports dual-curriculum schools, applying the ZIMSEC grading scale (1–7) or Cambridge grade bands (A*–U) correctly based on each student's curriculum assignment."],
    ['q' => 'How does TTS-300 handle teacher clashes when building the timetable?', 'a' => 'TTS-300 includes a clash detection engine that prevents a teacher or classroom being double-booked, alerting the timetabler and blocking conflicting allocations. It also manages split classes, double periods, and supports manual override with clash warnings.'],
    ['q' => 'What does AST-900 track beyond basic equipment lists?', 'a' => 'AST-900 manages the full asset lifecycle — acquisition, assignment, maintenance history, and disposal — and generates asset valuation and depreciation reports for Board and audit purposes.'],
    ['q' => "Can FIN-500 withhold a student's report card if fees are outstanding?", 'a' => 'Yes. FIN-500 integrates with RPT-800 to apply a configurable fee clearance gate: students with balances above a Headmaster-set threshold are flagged and their report cards held. The setting can be applied strictly, as a soft warning, or not at all.'],

    ['q' => 'We offer both ZIMSEC and Cambridge programmes. Can Edupro SMS handle both?', 'a' => 'Yes. Edupro SMS runs both curricula simultaneously within the same school; each student is assigned a curriculum and all relevant modules apply the appropriate framework for that student.'],
    ['q' => 'Does the system support the full ZIMSEC Heritage-Based Curriculum subject list?', 'a' => 'Yes. Edupro SMS includes the complete ZIMSEC Heritage-Based Curriculum subject list from ECD through A Level, with ZIMSEC subject codes pre-configured, plus support for custom or non-ZIMSEC subjects.'],
    ['q' => 'Does the system support Cambridge IGCSE, AS Level, and A Level?', 'a' => 'Yes. Edupro SMS supports IGCSE, AS Level, and Cambridge A Level with Cambridge grading bands, and configurable Cambridge Centre and Candidate Numbers in RPT-800.'],
    ['q' => 'Can the system produce ZIMSEC attendance certificates for examination candidates?', 'a' => 'Yes. ATT-300 generates individual attendance certificates per student per term in the ZIMSEC-required format for examination entry, printable or as PDF.'],
    ['q' => 'How does Edupro SMS handle practical subjects like Agriculture, Technical Drawing, and Art?', 'a' => 'RPT-800 supports practical subjects with separate, configurable assessment components — theory, practical, and project/coursework — each with its own weighting, and calculates the combined grade automatically.'],
    ['q' => 'We are a primary school only. Does Edupro SMS work for us?', 'a' => 'Yes. Edupro SMS works for ECD and primary schools, secondary schools, combined schools, and study centres. Gresham Primary School is one of the live deployments.'],

    ['q' => 'What are your support hours?', 'a' => 'The support team is in the office Monday to Friday, 07:30–16:30. A separate field team handles on-site deployments and visits. For P1 emergencies, the technical lead is reachable outside these hours.'],
    ['q' => 'What is a P1 emergency and how quickly will you respond?', 'a' => "A P1 (Priority 1) incident is when a school's Edupro SMS system is completely down during school hours. It is escalated immediately to the technical lead, with a standard response target within 4 hours remotely, or next business day on-site if needed."],
    ['q' => 'How do we contact support?', 'a' => 'Phone/WhatsApp +263 788 111 611 (school hours, Mon–Fri), email support@edupro.co.zw (4-hour response during school hours), or the contact form at edupro.co.zw/contact.php.'],
    ['q' => 'Do you provide ongoing system updates and improvements?', 'a' => "Yes. System updates — bug fixes, security patches, and feature improvements — are included for all Managed Services clients, and available on request for self-managed schools. Moodle updates are managed by Edupro's technical team."],
    ['q' => 'What if a teacher leaves and a new one joins — do we need to contact Edupro?', 'a' => "No. The school's System Administrator can create and deactivate user accounts directly without contacting Edupro; staff user management is self-service."],
    ['q' => 'Is there documentation or a user manual we can refer to?', 'a' => 'Yes. Full documentation is available at edupro.co.zw/docs.php, covering system architecture, module user guides, role-based instructions, curriculum configuration, and troubleshooting.'],
];

$_faq_ld = [];
foreach ($_faq_items as $_item) {
    $_faq_ld[] = [
        '@type'          => 'Question',
        'name'           => $_item['q'],
        'acceptedAnswer' => ['@type' => 'Answer', 'text' => $_item['a']],
    ];
}
$schema_json = ld_json([
