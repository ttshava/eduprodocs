...
$templatecontext = (object)[
    ...
    'forceblockdrawer'   => $PAGE->get_blocks_containing_types(['fake']),
    'activitynavigation' => $OUTPUT->activity_navigation(),
    'regionmainsettingsmenu' => $OUTPUT->region_main_settings_menu(),
    'hasregionmainsettingsmenu' => (bool)$PAGE->region_main_settings_menu(),
];

// SEO meta injected into <head>
$PAGE->requires->string_for_js('pluginname', 'theme_edupro_boost');
...
<div id="page" data-region="mainpage" data-usertour="scroller" class="drawers drag-container">
    ...
    <?php } else { ?>
    <div id="page-content" class="page-content pb-3 pr-0">
    <?php } ?>
...
// Fetch available courses for the footer quick-links (up to 8)
$courses = get_courses('all', 'c.sortorder ASC', 'c.id,c.fullname,c.shortname', 8);
$footer_courses = [];
foreach ($courses as $c) {
    if ($c->id == SITEID) continue;
    $footer_courses[] = [
        'name' => format_string($c->shortname ?: $c->fullname),
        'url'  => new moodle_url('/course/view.php', ['id' => $c->id]),
    ];
}
?>

<footer class="edupro-footer" role="contentinfo">
  <div class="edupro-footer-main">

    <!-- Brand column -->
    <div class="edupro-footer-brand">
      <a href="<?php echo $wwwroot; ?>">
      ...
      <!-- Social media -->
      <nav class="edupro-footer-social" aria-label="Edupro social media">
        <a href="https://www.facebook.com/eduprozw" target="_blank" rel="noopener noreferrer" aria-label="Facebook" class="social-fb">
        ...
        <a href="https://www.linkedin.com/company/eduprozw" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" class="social-li">
        ...
        <a href="https://www.instagram.com/eduprozw" target="_blank" rel="noopener noreferrer" aria-label="Instagram" class="social-ig">
        ...
        <a href="https://www.tiktok.com/@eduprozw" target="_blank" rel="noopener noreferrer" aria-label="TikTok" class="social-tt">
        ...
        <a href="https://www.youtube.com/@eduprozw" target="_blank" rel="noopener noreferrer" aria-label="YouTube" class="social-yt">
        ...
        <a href="https://wa.me/263772837385?text=Hello%2C%20I%27m%20interested%20in%20Edupro%20SMS." target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" class="social-wa">
    ...
    <!-- Quick links -->
    <nav class="edupro-footer-col" aria-label="Quick links">
      <h4><?php echo get_string('footerquicklinks', 'theme_edupro_boost'); ?></h4>
      <div class="edupro-footer-links">
        <a href="<?php echo $wwwroot; ?>"><?php echo get_string('home'); ?></a>
        <a href="<?php echo new moodle_url('/my'); ?>"><?php echo get_string('myhome'); ?></a>
        <a href="<?php echo new moodle_url('/course/index.php'); ?>"><?php echo get_string('courses'); ?></a>
        ...
        <a href="<?php echo new moodle_url('/user/profile.php'); ?>"><?php echo get_string('profile'); ?></a>
    ...
    <!-- Available courses -->
    <nav class="edupro-footer-col" aria-label="Available courses">
      <h4><?php echo get_string('footercourses', 'theme_edupro_boost'); ?></h4>
      <div class="edupro-footer-links">
        <?php if (!empty($footer_courses)): ?>
          <?php foreach ($footer_courses as $fc): ?>
            <a href="<?php echo $fc['url']; ?>"><?php echo $fc['name']; ?></a>
          <?php endforeach; ?>
        <?php else: ?>
          <a href="<?php echo new moodle_url('/course/index.php'); ?>"><?php echo get_string('courses'); ?></a>
        <?php endif; ?>
        <a href="<?php echo new moodle_url('/course/index.php'); ?>" style="margin-top:8px;color:#FF0527;font-weight:600;">
          <?php echo get_string('viewallcourses'); ?> →
        </a>
      </div>
    </nav>
    ...
    <div class="edupro-footer-col">
      ...
      <div class="edupro-footer-links">
        ...
        <span style="margin-top:8px;display:block;line-height:1.6;">
  ...
  <div class="edupro-footer-bar">
    ...
    <nav aria-label="Legal">
      ...
      &nbsp;·&nbsp;
      <a href="<?php echo new moodle_url('/admin/index.php'); ?>"><?php echo get_string('administrationsite'); ?></a>
    </nav>
  </div>
</footer>
